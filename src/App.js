  ...
  return (
    <div className="bg-gradient-to-t from-gray-900 via-gray-800 to-gray-600 h-screen">
      ...
      <div>
        ...
        {/* { Display Label } */}
      <div className="">
        <label className="flex justify-center py-5 mx-20 bg-gradient-to-r from-slate-700 to-gray-500 rounded-lg text-gray-200 outline outline-slate-500/80 outline-2 drop-shadow-lg">{quoteDisplay}</label>
      </div>
